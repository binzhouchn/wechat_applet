...
/* 12 */
/*!***************************************************************************************!*\
  !*** F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \***************************************************************************************/
...
/* 13 */
/*!********************************************************************!*\
  !*** F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue ***!
  \********************************************************************/
/*! no static exports found */
...
/* 14 */
/*!***************************************************************************************************!*\
  !*** F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***************************************************************************************************/
...
/* 15 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
try {
  components = {
    uniTag: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-tag/components/uni-tag/uni-tag */ "uni_modules/uni-tag/components/uni-tag/uni-tag").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-tag/components/uni-tag/uni-tag.vue */ 21))
    },
    uniPopup: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-popup/components/uni-popup/uni-popup */ "uni_modules/uni-popup/components/uni-popup/uni-popup").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-popup/components/uni-popup/uni-popup.vue */ 28))
    }
  }
} catch (e) {
  if (
...
/* 16 */
/*!*********************************************************************************************!*\
  !*** F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _uniCopy = _interopRequireDefault(__webpack_require__(/*! @/common/uni-copy.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {return { scrollInto: '', apiurl: 'http://binzhouchn.nat300.top', apisucc: false, apibut: 'need config to use', sentext: '先配置api', apiadj: 'please input ak ak!', api: '', msgLoad: true, anData: {}, animationData: {}, showTow: false, msgList: [{ my: false, msg: "你好，我是达芬奇三号~" }], msgContent: "", msg: "", sendmsgcache: [] };}, onLoad: function onLoad() {var _this = this;try {var value = 'sk-******DE8';if (value) {console.log('sk-******DE8');this.api = value;this.apiset();}} catch (e) {// error
      console.log(e);}uni.request({ url: this.apiurl, method: 'GET', success: function success(res) {console.log(res);_this.apiadj = res.data;} });}, methods: { setPageScrollTo: function setPageScrollTo() {var len = this.msgList.length;this.scrollInto = 'id' + (len - 1);}, copy: function copy(info) {(0, _uniCopy.default)({ content: info, success: function success(res) {uni.showToast({ title: res,
            icon: 'none' });
    ...
    // },
    setsklocal: function setsklocal(apikey) {
      uni.setStorage({
        key: 'sk',
        data: apikey,
    ...
    apiset: function apiset() {var _this2 = this;
      this.$refs.popup.close('center');
      this.apibut = '点击继续，弹框后按确认';
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          if (res.data.code == 200) {
            ...
            _this2.setsklocal(_this2.api);
          } else {
            _this2.$u.toast(res.data.resmsg);
            _this2.apibut = '连接失败，请检查apikey后重试';
          }
        } });
    ...
    sendMsg: function sendMsg() {var _this3 = this;
      ...
      this.msgContent = '';
      this.sendmsgcache.forEach(function (info) {
        console.log('info', info);
        _this3.msgContent += info;
      ...
      uni.request({
        ...
        success: function success(res) {
          if (res.data.code == 200) {
            ...
            replace(/^\n|\n$/g, "");
            console.log(text);
            var msglen = res.data.resmsg.usage.total_tokens;
            var msgcomplen = res.data.resmsg.usage.completion_tokens;
            if (msglen + msgcomplen > 1500) {
              for (var msg in _this3.sendmsgcache) {
                _this3.sendmsgcache.shift();
                if (_this3.msgContent.length * 1.6 + msglen < 800) {
                  console.log('ok');
                  break;
                }
              }
            ...
            console.log('su', _this3.msgList);


            _this3.sendmsgcache.push(text + "\n");
            _this3.msgLoad = false;
            _this3.sentext = '发送';
          } else {
            _this3.$u.toast(res.data.resmsg);
            _this3.apibut = '连接失败，请检查apikey后重试';
            _this3.apisucc = false;
          }
        },
        fail: function fail(res) {
          _this3.$u.toast('请求失败，内容超长，换个问题试试');
          _this3.sentext = '发送';
          _this3.msgLoad = false;
        } });
...
/* 19 */
/*!*****************************************************************************************************!*\
  !*** F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!F:/创意/IP/项目/GPT/小程序版本/代码文件/前/整体项目/CHAT/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
